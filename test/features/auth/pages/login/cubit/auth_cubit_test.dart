...
void main() {
  ...
  blocTest<AuthCubit, AuthState>(
    ...
    build: () {
      when(mockPostLogin.call(loginParams)).thenAnswer((_) async => Right(login));
  ...
  blocTest<AuthCubit, AuthState>(
    ...
    build: () {
      when(mockPostLogin.call(loginParams)).thenAnswer((_) async => const Left(ServerFailure(errorMessage)));
