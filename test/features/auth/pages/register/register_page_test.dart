...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      when(() => registerCubit.state).thenReturn(const RegisterState.success(null));
  ...
  testWidgets(
    'renders RegisterPage for form validation fill email,' + 'password, repeat password (not match)',
    (tester) async {
      const email = "test@gmail.com";
      const password = "password";
