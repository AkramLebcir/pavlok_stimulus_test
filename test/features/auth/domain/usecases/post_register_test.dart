...
void main() {
  ...
  const registerParams = RegisterParams(email: 'test@gmail.com', password: 'password');
  ...
  test("should get register from the repository", () async {
    /// arrange
    when(mockAuthRepository.register(registerParams)).thenAnswer((_) async => Right(register));
